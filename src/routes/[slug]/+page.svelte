...
<svelte:head>
  ...
  <meta name="description" content={post ? post.content.slice(0, 150) : 'The Journey of a Pharmacist'} />

  <!-- Open Graph meta tags for social media sharing -->
  <meta property="og:title" content={post ? post.title : 'RxJourney'} />
  <meta property="og:description" content={post ? post.content.slice(0, 150) : 'The Journey of a Pharmacist'} />
  ...
  <meta name="twitter:description" content={post ? post.content.slice(0, 150) : 'The Journey of a Pharmacist'} />
